...
class FC:
    ...
    class PatternIter(ct.Structure):
        _fields_ = [("dummy1", ct.c_void_p), ("dummy2", ct.c_void_p)]
    ...
    Value._fields_ = [("type", ct.c_uint), ("u", ValUnion)]  # Type
    ValUnion
...
class LangSet:
    ...
    __slots__ = ("_fcobj", "_created")  # to forestall typos
    ...
    def copy(self):
        return celf(fc.FcLangSetCopy(self._fcobj), True)
...
class Blanks:
    ...
    __slots__ = ("_fcobj", "_created", "__weakref__")  # to forestall typos
...
class Config:
    ...
    __slots__ = ("_fcobj", "__weakref__")  # to forestall typos
    ...
    @staticmethod
    def home():
        return fc.FcConfigHome().decode()  # automatically stops at NUL?
